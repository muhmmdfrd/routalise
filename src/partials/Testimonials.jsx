        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-3 md:pb-4">
            <h2 className="h2 mb-4">
              Trusted by over 1,000,000 people all over the world
            </h2>
            <p className="text-xl text-gray-600" data-aos="zoom-y-out">
              Many have noticed your qualities. Here is one that truly
            ...
            <div className="relative flex items-start border-2 border-gray-200 rounded bg-white">
              ...
              <div className="text-center px-12 py-8 pt-20 mx-4 md:mx-0">
                ...
                <blockquote className="text-xl font-medium mb-4">
                  “ I've known her. She is smart, beautiful and she is ambitious
                  with a strong determination. I love her💕“
                </blockquote>
