      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">How Do You Improve Your Life</h2>
            <p className="text-xl text-gray-600">
              Here is a suggestion that I would like to convey to you. This is
              just my personal opinion, but I always hope the best for you.
            </p>
          </div>
